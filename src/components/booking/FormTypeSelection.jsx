  ...
  return (
    <div>
      <div className="w-[700px] mx-auto text-center mb-6 mt-5">
        <h1 className="text-3xl font-bold text-sky-500 mb-2">Các hình thức đặt khám</h1>
      ...
      <div className="w-[700px] mx-auto flex flex-col mt-14 gap-6">
        <div className="flex gap-6 w-full">
          ...
          >
            <img
              src="/images/icon-banner/icon1.png"
              alt="Đặt khám theo chuyên khoa"
              className="w-[35px] h-[35px] mr-4"
            />
            <span className="text-base font-medium text-gray-800">Đặt khám theo chuyên khoa</span>
          </button>
          ...
          >
            <img
              src="/images/icon-banner/icon2.png"
              alt="Gói khám sức khỏe"
              className="w-[35px] h-[35px] mr-4"
            />
            <span className="text-base font-medium text-gray-800">Gói khám sức khỏe</span>
          </button>
        </div>
      </div>
    </div>
